...
kv "$out" "MODEL_FEATURE=claude-opus-4-8"        "standard: MODEL_FEATURE changed"
kv "$out" "MODEL_QUICK=claude-sonnet-4-6"        "standard: MODEL_QUICK changed"
...
kv "$out" "MODEL_REVIEW=claude-opus-4-8"         "standard: MODEL_REVIEW changed"
...
kv "$out" "MODEL_FEATURE=claude-opus-4-8"        "unset: MODEL_FEATURE changed"
kv "$out" "MODEL_QUICK=claude-sonnet-4-6"        "unset: MODEL_QUICK changed"
...
kv "$out" "MODEL_REVIEW=claude-opus-4-8"         "unset: MODEL_REVIEW changed"
