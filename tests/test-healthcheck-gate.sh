...
# HERD-458: pin our own precondition — a CONFIGURED caller can leave an ambient HEALTH_CONCURRENCY
# already exported (e.g. =2), which check (1)'s "HEALTH_CONCURRENCY should default to 1" assertion
# below would otherwise inherit instead of the unset default. The shared harness scrub
