...
EXEMPT_NAMES = {
    ...
    "GROK_BIN",  # HERD-800: grok-exec-adapter.sh's test seam for the grok binary path (defaults to
                 # plain 'grok' on PATH) — the exact same class as CODEX_BIN above, a stub-swap seam for
                 # the hermetic adapter test, never a .herd/config knob.
