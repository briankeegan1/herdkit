...
#
# Budget 50s: this posture's matrix run includes an internal fault-injection re-check, plus this file's
# own direct fault re-run to assert the scorecard precisely (measured ~28s locally combined).
...
posture_matrix_case custom-steps 50
